...
//        InhibitTimerDuration = *(UNS16 *)(d->Find_Object(NULL,(0x18000003 | (pdoNum<<16)), &errorCode, d) -> p_content);
        EventTimerDuration = *(UNS32 *)(d->Find_Object(NULL, (0x18000005 | (pdoNum<<16) ), &errorCode, d) -> p_content);
        InhibitTimerDuration = *(UNS32 *)(d->Find_Object(NULL,(0x18000003 | (pdoNum<<16)), &errorCode, d) -> p_content);

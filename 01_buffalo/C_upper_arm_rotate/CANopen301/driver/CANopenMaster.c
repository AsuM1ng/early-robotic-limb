...
UNS32 CANopenMaster_obj1600[] =
                    {
                        0x00,     /*position actual value*/
                        0x00,     /*velocity actual value*/
                    };
...
OD_OI_TypeDef  can_master_receive_PDO_1_mapping[]=
{
  ...
  {"RPDO1 Mapping1",  	 0x16000001, OD_OBJCODE_NULL, OD_DATATYPE_U32, OD_ACCESS_RW,  (void *)&CANopenMaster_obj1600[0], 0, NULL, "映射参数值为0x60640000" },
  {"RPDO1 Mapping2", 	 0x16000002, OD_OBJCODE_NULL, OD_DATATYPE_U32, OD_ACCESS_RW,  (void *)&CANopenMaster_obj1600[1], 0, NULL, "映射参数值为0x30D10001" },
};
...
OD_OI_TypeDef  can_master_receive_PDO_2_mapping[]=
{
	...
	{"RPDO2 Mapping1",     0x16010001, OD_OBJCODE_NULL, OD_DATATYPE_U32, OD_ACCESS_RW,  (void *)&CANopenMaster_obj1601[0], 0, NULL, "映射参数值为 0x603F0000" },
	{"RPDO2 Mapping2",     0x16010002, OD_OBJCODE_NULL, OD_DATATYPE_U32, OD_ACCESS_RW,  (void *)&CANopenMaster_obj1601[1], 0, NULL, "映射参数值为 0x60410000" },
};
...
OD_OI_TypeDef  can_master_receive_PDO_3_mapping[]=
{
  ...
  {"RPDO3 Mapping1",     0x16020001, OD_OBJCODE_NULL, OD_DATATYPE_U32, OD_ACCESS_RW,  (void *)&CANopenMaster_obj1602[0], 0, NULL, "映射参数值为 0x60410000" },
  {"RPDO3 Mapping2",     0x16020002, OD_OBJCODE_NULL, OD_DATATYPE_U32, OD_ACCESS_RW,  (void *)&CANopenMaster_obj1602[1], 0, NULL, "映射参数值为 0x603F0000" },
};


///////////////////////////////////////////////////////////////////////////
extern OD_OI_TypeDef  can_master_receive_PDO_4_mapping[];
UNS8 CANopenMaster_highestSubIndex_obj1603 = 2; /* number of subindex - 1*/
UNS32 CANopenMaster_obj1603[] = 
                    {
                        0x00,        /*Position demand value*/
                        0x00,
                    };
...
OD_OI_TypeDef  can_master_receive_PDO_4_mapping[]=
{
  ...
  {"RPDO4 Mapping2",  	 0x16030002, OD_OBJCODE_NULL, OD_DATATYPE_U32, OD_ACCESS_RW,  (void *)&CANopenMaster_obj1603[1],              0, NULL, "映射参数值为 0x603F0000" },
};
...
UNS32 CANopenMaster_obj1A00[] = 
                    {
                      0x2F130000,	/* CANopenMaster_obj1A00[0] */
...
OD_OI_TypeDef  can_master_transmit_PDO_1_mapping[]=
{
	...
	{"TPDO1 Mapping1",     0x1A000001, OD_OBJCODE_NULL, OD_DATATYPE_U32, OD_ACCESS_RW,  (void *)&CANopenMaster_obj1A00[0], 0, NULL, "映射参数值为0x2F130000" },									
...
//{
//	{"PVT demand position", 0x2F120000, OD_OBJCODE_VAR, OD_DATATYPE_I32, OD_ACCESS_RW, (void *)&JointCtrl.PVT_struct.i32PVT_P_Target, 0, NULL, "PVT插补点" },
//};
...
//extern INTEGER32 adjust_position_ref;
//OD_OI_TypeDef CANopenMaster_Index2F13[] = 
//{
//	{"adjust demand position",               0x2F130000, OD_OBJCODE_VAR,    OD_DATATYPE_I32,    OD_ACCESS_RW,   (void *)&adjust_position_ref,                  0, NULL, "阻抗调整参考位置" },	
//};
...
//    {"RPDO4 Com",                           0x140300FF, OD_OBJCODE_RECORD, OD_DATATYPE_PDOCP,  OD_ACCESS_RW,  (void *)&can_master_receive_PDO_4_parameter,   6, NULL, "RPDO4通信参数" },
...
//	{"adjust demand position",              0x2F130000, OD_OBJCODE_VAR,    OD_DATATYPE_I32,    OD_ACCESS_RW,   (void *)&adjust_position_ref,                    0, NULL, "阻抗调整参考位置" },	
    ...
    {"current actual value",                0x30D10001, OD_OBJCODE_VAR,    OD_DATATYPE_I32,     OD_ACCESS_RW,   (void *)&EposCtrl.i32ServoAveragedCurrent,      0, NULL, "电机实际电流" },
	{"torque average value",                0x30D20001, OD_OBJCODE_VAR,    OD_DATATYPE_I16,     OD_ACCESS_RW,   (void *)&EposCtrl.i16TorqueAverageValue,        0, NULL, "电机实际扭矩 千分比" },	
	{"error code servo",                    0x603F0000, OD_OBJCODE_VAR,    OD_DATATYPE_U16,     OD_ACCESS_RW,   (void *)&EposCtrl.u16ErrorCode,                 0, NULL, "伺服驱动器的错误码" },
	{"controlword from servo",              0x60400000, OD_OBJCODE_VAR,    OD_DATATYPE_U16,     OD_ACCESS_RW,   (void *)&EposCtrl.u16Controlword,               0, NULL, "伺服驱动器的控制字" },
	{"statusword from servo",               0x60410000, OD_OBJCODE_VAR,    OD_DATATYPE_U16,     OD_ACCESS_RW,   (void *)&EposCtrl.u16Statusword.u16AllStatus,   0, NULL, "伺服驱动器的状态字" },
	{"modes of operation",                  0x60600000, OD_OBJCODE_VAR,    OD_DATATYPE_U8,      OD_ACCESS_RW,   (void *)&EposCtrl.enEpos4OpMode,                0, NULL, "伺服驱动器模式状态" },	
	{"position demand value",               0x60620000, OD_OBJCODE_VAR,    OD_DATATYPE_I32,     OD_ACCESS_RW,   (void *)&EposCtrl.i32ServoDemandPosition,       0, NULL, "伺服驱动器需求位置" },	
    {"position actual value",               0x60640000, OD_OBJCODE_VAR,    OD_DATATYPE_I32,     OD_ACCESS_RW,   (void *)&EposCtrl.i32ServoActualPosition,       0, NULL, "电机实际位置" },
	{"velocity actual value",               0x606C0000, OD_OBJCODE_VAR,    OD_DATATYPE_I32,     OD_ACCESS_RW,   (void *)&EposCtrl.i32ServoActualVelocity,       0, NULL, "实际速度" },	
	{"target position",                     0x607A0000, OD_OBJCODE_VAR,    OD_DATATYPE_I32,     OD_ACCESS_RW,   (void *)&EposCtrl.i32ServoTargetPosition,       0, NULL, "伺服目标位置" },	
	{"profile velocity",                    0x60810000, OD_OBJCODE_VAR,    OD_DATATYPE_U32,     OD_ACCESS_RW,   (void *)&EposCtrl.u32ServoProfileVelocity,      0, NULL, "伺服设定速度" },	
	{"profile acceleration",                0x60830000, OD_OBJCODE_VAR,    OD_DATATYPE_U32,     OD_ACCESS_RW,   (void *)&EposCtrl.u32MotorAcceleration,         0, NULL, "伺服设定加速度" },	
	{"profile velocity",                    0x60840000, OD_OBJCODE_VAR,    OD_DATATYPE_U32,     OD_ACCESS_RW,   (void *)&EposCtrl.u32MotorDeceleration,         0, NULL, "伺服设定减速度" },	
};
/*EposCtrl.u16Statusword.u16AllStatus*/

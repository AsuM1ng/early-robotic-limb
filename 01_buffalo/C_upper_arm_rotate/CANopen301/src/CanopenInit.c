...
//	{
//		UNS16 ProducerHeartBeatTime = 100;/* UNS16型数据，给值不能超65535，单位为毫秒：ms */
...
//    /*Define Producer HeartBeat time*/
//	{
//		UNS16 ProducerHeartBeatTime = 1000;/* UNS16型数据，给值不能超65535，单位为毫秒：ms */
//		setODentry(&TestSlave_Data, 0x1016, 0x00, &ProducerHeartBeatTime, &sizeUNS16, OD_ACCESS_RW);
//	}

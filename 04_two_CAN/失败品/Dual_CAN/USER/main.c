...
//		delay_ms(60000);
		...
		//用CAN2发消息
//		delay_ms(1500);
//		sendSDO(&Master2_Data,SDO_CLIENT,0,EPOS_disable);
//		sendSDO(&Master2_Data,SDO_CLIENT,0,activ_PVM);
////		delay_ms(10);
//		sendSDO(&Master2_Data,SDO_CLIENT,0,EPOS_disable);
////		delay_ms(10);
//		sendSDO(&Master2_Data,SDO_CLIENT,0,EPOS_enable);
////		delay_ms(10);
//		sendSDO(&Master2_Data,SDO_CLIENT,0,shoulder_target_120rpm);
////		delay_ms(10);
//		sendSDO(&Master2_Data,SDO_CLIENT,0,EPOS_enable);
////		delay_ms(15000);
//		sendSDO(&Master2_Data,SDO_CLIENT,0,PVM_Halt);
////		delay_ms(60000);
////		delay_ms(60000);
	}
}

...
static void CAN_GPIO_Config(void)
{
    ...
    //配置CAN1和CAN2发送引脚
    GPIO_InitStructure.Pin = CAN1_TX_PIN | CAN2_TX_PIN;
    GPIO_InitStructure.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStructure.Speed = GPIO_SPEED_FAST;
    GPIO_InitStructure.Pull  = GPIO_PULLUP;
    GPIO_InitStructure.Alternate =  GPIO_AF9_CAN1;
    HAL_GPIO_Init(CAN1_TX_GPIO_PORT | CAN2_TX_GPIO_PORT, &GPIO_InitStructure);

    //配置CAN1和CAN2接收引脚
    GPIO_InitStructure.Pin = CAN1_RX_PIN | CAN2_RX_PIN;
    HAL_GPIO_Init(CAN1_RX_GPIO_PORT | CAN2_RX_GPIO_PORT, &GPIO_InitStructure);
}

...
#define CAN1_RX_GPIO_CLK_ENABLE()        do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)     /* PA口时钟使能 */

#define CAN1_TX_GPIO_PORT                GPIOA
#define CAN1_TX_GPIO_PIN                 GPIO_PIN_12
#define CAN1_TX_GPIO_CLK_ENABLE()        do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)     /* PA口时钟使能 */

//CAN2引脚定义
#define CAN2_RX_GPIO_PORT                GPIOB
#define CAN2_RX_GPIO_PIN                 GPIO_PIN_5
#define CAN2_RX_GPIO_CLK_ENABLE()        do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)     /* PA口时钟使能 */

#define CAN2_TX_GPIO_PORT                GPIOB
#define CAN2_TX_GPIO_PIN                 GPIO_PIN_6
#define CAN2_TX_GPIO_CLK_ENABLE()        do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)     /* PA口时钟使能 */
